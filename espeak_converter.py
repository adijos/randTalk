# espeak_converter.py
# a set of functions to convert nettalk phonemes to those used in espeak for speech synthesis
# !! code from github.com/jsonnikson/netwhisperer/to_espeak.py
...
def getPhonemeMapping():
        ...
        'v':'v',
        'w':'w',
        'x':'@', #using a2 here ruins espeak for some reason
        'y':'j',
        'z':'z',
        'A':'aI',
        'C':'tS',
